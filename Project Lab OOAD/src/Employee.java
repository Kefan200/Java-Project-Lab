...
public class Employee extends JInternalFrame implements MouseListener,ActionListener{
...
//			String status=(String) employeestatusbox.getItemAt(employeestatusbox.getSelectedIndex());
			...
			if(MenuControllerEmployee.updateMenu(id, role, name, username, status, salary)) {
				refreshTable();
...
//			int id=Integer.parseInt(employeeidField.getText());
			...
			if(MenuControllerEmployee.deleteMenu(id,status)){
				refreshTable();
				employeeroleField.setText("");
				employeenameField.setText("");
				employeeusernameField.setText("");
