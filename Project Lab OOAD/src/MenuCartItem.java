...
public class MenuCartItem {
	...
	public MenuCartItem(int id, int quantity, String method, String date) {
		super();
		this.id = id;
	...
	public Vector<MenuCartItem>getAll(){
		Vector<MenuCartItem>menus=new Vector<>();
		try {
			...
			while(rs.next()) {
				...
				MenuCartItem menucartitem=new MenuCartItem(id,quantity,method,date);
				menus.add(menucartitem);
			}
			return menus;
